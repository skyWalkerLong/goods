package cn.scu.goods.order.servlet;
...
import cn.scu.goods.order.domain.Order;
import cn.scu.goods.order.domain.OrderItem;
import cn.scu.goods.order.service.OrderService;
...
public class OrderServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		if(request.getParameter("mark").equals("myOrders")){
			myOrders(request,response);
		}
		
		if(request.getParameter("mark").equals("createOrder")){
		...
		if(request.getParameter("mark").equals("cancel")){
			cancel(request,response);
		}

		if(request.getParameter("mark").equals("confirm")){
			confirm(request,response);
		}
		
		if(request.getParameter("mark").equals("paymentPre")){
			paymentPre(request,response);
		}
		if(request.getParameter("mark").equals("back")){
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		if(request.getParameter("mark").equals("payment")){
	...
	public void createOrder(HttpServletRequest req, HttpServletResponse resp)
		 ...
		 */
		req.setAttribute("order", order);
		req.getRequestDispatcher("/jsps/order/ordersucc.jsp").forward(req, resp);
	}
	 ...
	 * @throws IOException
	 */
	public void myOrders(HttpServletRequest req, HttpServletResponse resp)
			throws ServletException, IOException {
		/*
